...
def test_env_testing_exist(config_path_testing_ok):
    assert os.path.exists(config_path_testing_ok)

def test_env_testing_fresh_exist(config_path_testing_fresh_func):
    assert os.path.exists(config_path_testing_fresh_func)

def test_env_applied(config_path_default, config_path_testing_ok):
